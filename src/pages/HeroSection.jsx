    ...
    >
      ...
      <div className="relative z-20 container mx-auto px-6 h-full flex flex-col items-start justify-center text-left pointer-events-none">
        ...
        >
          ...
          >
            <span className="text-primary font-mono text-[11px] tracking-[0.5em] uppercase">Mechanical Engineering Portfolio</span>
          </motion.div>
      ...
      >
        <span className="text-[10px] font-mono text-primary tracking-[0.4em] uppercase">Explore My Work</span>
